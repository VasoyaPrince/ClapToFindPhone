...
class ChargerPopupActivity : AppCompatActivity() {
    lateinit var binding: ActivityChargerPopupBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityChargerPopupBinding.inflate(layoutInflater)
        ...
        binding.ivPopup.setOnClickListener {
            mPlayer?.stop()
           // startActivity(Intent(this,ChargerDisconnectActivity::class.java))
            finish()
        }
